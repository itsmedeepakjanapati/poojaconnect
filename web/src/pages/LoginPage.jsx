...
import { loginUser, loginWithGoogle } from '../../../shared/services/authService';
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-7 border border-gray-100">
          ...
          <p className="text-center text-sm text-gray-500 mt-5">
            Don't have an account? <Link to="/register" className="font-semibold" style={{ color: '#E8712A' }}>Register</Link>
          </p>
        </div>
      </div>
    </div>
